"""
kwaivgi/kling-v3-video — Kling v3 video generation model.

Características:
  - Text-to-video o image-to-video (con frame inicial vía image_input)
  - Output: video 9:16 / 16:9 / 1:1, con audio opcional
  - Duración configurable (default 5s)
  - NO soporta reference_images (sólo image-to-video puro)
...
Docs: https://replicate.com/kwaivgi/kling-v3-video
"""
